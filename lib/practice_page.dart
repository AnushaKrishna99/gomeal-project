...
import 'package:gomeal/file_upload.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Container(
                          margin: EdgeInsets.only(right: 470.0,top: 20.0),
                        ...
                        Container(
                          margin: EdgeInsets.only(top: 10.0,right: 200.0),
                              ...
                              Column(
                                children: [
                                  Container(
                                    ...
                                    child: Text("Resturant Name",style: TextStyle(
                                      fontFamily: 'Poppins',
                                      color: Colors.grey,
                                      fontSize: 12,
                                    ),),
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text("Restuaranr Logo",style: TextStyle(
                                fontFamily: 'Poppins',
                                color: Colors.grey,
                                fontSize: 12,
                              ),
                        ...
                        SizedBox(height: 20.0,),
                        Container(
                          margin: EdgeInsets.only(left: 420.0,top: 10.0),
